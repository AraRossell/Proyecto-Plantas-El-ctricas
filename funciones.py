...
'''
Presentar el consumo total del mes ingresado en cada una de las plantas y el 
valor total entre ambas
    ...
    if mes<=12:
        for planta in consumo_energia:
            for ciudadDic in consumo_energia.get(planta):
                ...
                acumulaValor+=consumo*tarifa #26000
...
def buscarPlantasPorCiudad(ciudad):
    diccionario={}
    for planta in consumo_energia: #gfyhdgdf
        for ciudadDic in consumo_energia.get(planta):
            if ciudadDic==ciudad:
